...
COLOR_DOOR              equ     $40
COLOR_DOOR_YELLOW       equ     $60
COLOR_DOOR_RED          equ     $10
...
TITLE_VERSION_SPRITE_COL equ    TITLE_SCENE_FRAME_LEFT_COL+TITLE_SCENE_FRAME_WIDTH-1
TITLE_VERSION_SPRITE_ROW equ    TITLE_SCENE_FRAME_TOP_ROW+TITLE_SCENE_FRAME_HEIGHT
